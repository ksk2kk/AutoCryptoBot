...
use self::rest::BitgetRestClient;
use self::ws::BitgetWsManager;
...
impl BitgetConnector {
    pub fn new(rest_url: &str, ws_url: &str) -> Self {
        Self {
            rest: BitgetRestClient::new(rest_url),
            ws: BitgetWsManager::new(ws_url),
...
impl ExchangeConnector for BitgetConnector {
    ...
    async fn connect(&self) -> Result<()> {
        ...
        tracing::info!(exchange = "bitget", "Connected to Bitget");
        Ok(())
    }
    ...
    async fn disconnect(&self) -> Result<()> {
        ...
        tracing::info!(exchange = "bitget", "Disconnected from Bitget");
        Ok(())
    }
